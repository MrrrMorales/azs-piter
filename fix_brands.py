...
BRAND_REPLACE = [
    # Киришиавтосервис — parent = Сургутнефтегаз, brand = Киришиавтосервис
    ('киришиавтосервис', 'Сургутнефтегаз',      'Киришиавтосервис'),
    ('киришиавтосервис', 'ООО Киришиавтосервис', 'Киришиавтосервис'),
    ('киришиавтосервис', 'КиришиАвтоСервис',     'Киришиавтосервис'),
    # Кинеф — историческое название Киришиавтосервис, оставляем как есть
