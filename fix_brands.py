...
ID_OVERRIDES = {
    ...
    # Газпром нефть, Ленобласть, 41К-174 — в OSM нет бренда/адреса (2026-04, Яндекс Карты)
    1153586111: {'brand': 'Газпром нефть', 'name': 'Газпром нефть', 'address': 'Ленинградская область, 41К-174', 'opening_hours': '24/7'},
}
