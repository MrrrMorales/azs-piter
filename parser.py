...
BRAND_ALIASES = {
    ...
    'птк': 'птк', 'ptk': 'птк',
    'петербургская топливная': 'птк',
    'пикалёвская топливная': 'птк',
    'neste': 'neste', 'несте': 'neste',
    'татнефть': 'татнефть', 'tatneft': 'татнефть',
    'teboil': 'teboil', 'тебойл': 'teboil',
    'shell': 'shell',
    'авро': 'авро', 'avro': 'авро',
    'трасса': 'трасса', 'trassa': 'трасса',
    'кинеф': 'сургутнефтегаз', 'kinef': 'сургутнефтегаз',
    'киришиавтосервис': 'сургутнефтегаз', 'kirishiavtoservis': 'сургутнефтегаз',
    'сургутнефтегаз': 'сургутнефтегаз', 'сургут': 'сургутнефтегаз',
    'esso': 'esso',
    'nord point': 'nord point', 'норд поинт': 'nord point',
    'линос': 'линос', 'linos': 'линос',
    'aris': 'aris',
    'китэк': 'китэк', 'kitek': 'китэк',
    'втк': 'втк', 'выборгская топливная': 'втк',
    'санга': 'санга', 'sanga': 'санга',
    'фаэтон': 'фаэтон', 'фаэтон-аэро': 'фаэтон', 'faeton': 'фаэтон',
    'shelf': 'shelf',
    'опти': 'опти', 'opti': 'опти',
    'bp': 'bp',
}
...
BRAND_MAP = {
    ...
    'сургут':        'сургутнефтегаз',
    'esso':         'esso',
    'nord point':   'nord point',
    'норд поинт':   'nord point',
    'линос':        'линос',
    'aris':         'aris',
    'китэк':        'китэк',
    'втк':          'втк',
    'выборгская топливная': 'втк',
    'санга':        'санга',
    'фаэтон':       'фаэтон',
    'фаэтон-аэро':  'фаэтон',
    'shelf':        'shelf',
...
def parse_benzoportal():
    ...
    r = safe_get('https://benzoportal.ru/price/?city=2')
    if not r:
        return {}
